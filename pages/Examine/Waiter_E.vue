<template>
  <div>
    <el-table :data="waiters" stripe style="width: 100%">
      ...
      <el-table-column align="center" prop="bankCard" label="银行卡号" />
      ...
      <el-table-column align="center" fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button
            type="text"
            size="small"
            @click="examineHandler(scope.row.id)"
            >审核</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog title="审核员工" :visible.sync="dialogFormVisible">
      ...
      <div class="left">
        ...
        <img
          ...
          height="120"
          :src="
            'http://134.175.100.63:8686/' + this.waiter_id.idcardPhotoPositive
          "
        />
      </div>
      <div class="right">
        ...
        <img
          ...
          height="120"
          :src="
            'http://134.175.100.63:8686/' + this.waiter_id.idcardPhotoNegative
          "
        />
      </div>
