<template>
  <div class="category">
    <!-- 按钮 -->
    <el-button type="primary" size="small" @click="toAddHandler"
      >添加</el-button
    >
    <div class="select">
      <el-input
      ...
      ></el-input>
      <div class="btn">
        <el-button type="primary" @click="submitHanlderbyStatus" size="small"
          >查询</el-button
        >
      </div>
    </div>
    ...
    <el-table :data="categorys" stripe style="width: 100%">
      ...
      <el-table-column align="center" prop="name" label="栏目名称">
      </el-table-column>
      <el-table-column align="center" prop="num" label="序号">
      </el-table-column>
      <el-table-column align="center" prop="parentId" label="父栏目">
      </el-table-column>
      <el-table-column align="center" fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          ...
          <el-button @click="editHandler(scope.row)" type="text" size="small"
            >编辑</el-button
          >
          <el-button @click="detailsHandler(scope.row)" type="text" size="small"
            >详情</el-button
          >
        </template>
      </el-table-column>
