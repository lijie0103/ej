<template>
  <div class="customer">
    ...
    <!-- 表格 -->
    <!-- 分页 -->
    <el-pagination layout="total,prev, pager, next" :page-size="this.list.pageSize" :total="total" @current-change="changePageNum"/>
    <!-- 分页 -->
    <!-- 模态框 -->
...
export default {
  ...
  methods: {
    ...
    // 修改顾客信息
    editHandler(customerForm) {
      this.title = "修改顾客信息";
      this.form = customerrForm;
      this.dialogFormVisible = true;
    },
    // 详情页面
    detailsHandler(id) {
