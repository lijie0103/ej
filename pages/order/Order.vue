  ...
  <div class="custermer">
    <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                size="small"
                @click="details_Handler(scope.row.id)"
                >详情</el-button
              >
            </template>
          </el-table-column>
      ...
      <el-tab-pane label="待支付" name="second">
        <!-- 表格 -->
        <el-table :data="order1" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
      ...
      <el-tab-pane label="待派单" name="third">
        <!-- 表格 -->
        <el-table :data="order2" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
        ...
        <el-dialog title="派单" :visible.sync="dialogFormVisible">
          <!-- <el-radio v-for="r in waiter" v-model="waiterId" :label="r.id">
            {{r.realname}}
          </el-radio> -->
          <div slot="footer" class="dialog-footer">
            <el-button @click="close">取 消</el-button>
            <el-button type="primary" @click="submit('orderId')"
              >确 定</el-button
            >
          </div>
        </el-dialog>
      ...
      <el-tab-pane label="待接单" name="fourth">
        <!-- 表格 -->
        <el-table :data="order3" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
      ...
      <el-tab-pane label="待服务" name="five">
        <!-- 表格 -->
        <el-table :data="order4" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
      ...
      <el-tab-pane label="待确认" name="six">
        <!-- 表格 -->
        <el-table :data="order5" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
      ...
      <el-tab-pane label="已完成" name="seven">
        <!-- 表格 -->
        <el-table :data="order6" stripe style="width: 100%">
          <el-table-column
            align="center"
            prop="id"
            label="订单编号"
